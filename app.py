    ...
    if choice == "Detailed Report":
        ...
        if data_file is not None:
            ...
            if st.button(" Click Here To Generate The Detailed Report"):
                st.write(
                    "Please wait, it may take few minitues if dataset is large")
        ...
        st.write(
            " Handy tool to Analyze Csv Files [Click Here](https://share.streamlit.io/pratap517/streamlitapp_dataanalysis/main/main_app.py)")
        st.write(
            " Simple loan Prediction App [Click Here](https://share.streamlit.io/pratap517/ml_deploy_using_streamlit/main/app.py)")
        st.write(
            " Live Mask Detection App [Click Here](https://mask-detection-5a800.firebaseapp.com/)")
        ...
        st.write(" If in case page crashes, most cases you can reload the page to dismiss this error or if not try csv file with less features and size upto 5 Mb, if size is more it may  fail to process.")
